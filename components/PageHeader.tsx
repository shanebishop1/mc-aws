...
export const PageHeader = ({ onOpenCosts, onOpenEmails, awsConsoleUrl }: PageHeaderProps) => {
  ...
  const iconButtonClassName =
    "cursor-pointer p-1 rounded-full bg-white/70 ring-1 ring-charcoal/10 hover:bg-white text-charcoal/60 hover:text-green opacity-90 hover:opacity-100 transition-colors";
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 items-center gap-y-2 text-center xl:grid-cols-[1fr_auto_1fr] xl:gap-y-0 xl:h-12">
        ...
        <div className="xl:col-start-3 min-w-0 flex flex-wrap justify-center gap-3 xl:flex-nowrap xl:items-center xl:justify-end xl:mr-8">
          {/* GitHub Button */}
          <motion.a
