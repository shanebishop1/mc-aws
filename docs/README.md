...
- Account prerequisites: [AWS](setup/AWS_ACCOUNT_SETUP.md), [Cloudflare](setup/CLOUDFLARE_SETUP.md), [Google OAuth](setup/GOOGLE_OAUTH_SETUP.md), [GitHub repository](setup/GITHUB_REPO_SETUP.md), and [GitHub token](setup/GITHUB_TOKEN_SETUP.md)
