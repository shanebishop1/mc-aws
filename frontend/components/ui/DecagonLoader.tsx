...
export function DecagonLoader({ status, className }: DecagonLoaderProps) {
  ...
  const colorClass = isRunning ? "stroke-luxury-green" : isStopped ? "stroke-luxury-black/30" : "stroke-luxury-black";
